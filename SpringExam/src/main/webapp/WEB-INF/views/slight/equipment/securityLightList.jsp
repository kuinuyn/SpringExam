...
<div id="container">
	...
	<div id="sub">
		...
		<form id="slightForm" name="slightForm" method="post" action="/">
			...
			<!-- 지역선택box -->
			<div id="area_box">
				<table summary="보안등관리 지역목록"  cellpadding="0" cellspacing="0" >
					<colgroup>
						<col width="16%">
						<col width="17%">
						<col width="17%">
		...
		<div id="board_list">
			<!-- 보안등관리 리스트 -->
			<table summary="보안등관리" cellpadding="0" cellspacing="0">
				<colgroup>
					<col width="12%">
					<col width="20%">
					<col width="20%">
				...
				<thead>
					<tr>
						<p class="tt"><th class="sortable" onclick="sortEvent(this)"><p class="tt">관리번호<span class="tt-text">클릭 시 관리번호에 따라 정렬순서 변경</span></p></th>
						<th>주소</th>
						<th>도로명주소</th>
						<th>지지방식</th>
						<th>광원종류</th>
		...
		<div class="pop-container">
			<div class="pop-conts">
				...
				<div class="pop_detail2 ">
					...
					<div id="board_view">
						<!-- 보안등상세내역-->
						<table summary="보안등상세" cellpadding="0" cellspacing="0">
							<colgroup>
								<col width="14%">
								<col width="36%">
								<col width="14%">
