...
<div id="container">
	...
	<div id="sub">
		...
		<div id="board_list">
			<!-- 가로등관리 리스트 -->
			<table summary="가로등관리" cellpadding="0" cellspacing="0">
				<colgroup>
					<col width="12%">
					<col width="20%">
					<col width="20%">
		...
		<div class="pop-container">
			<div class="pop-conts">
				...
				<div class="pop_detail2 ">
					...
					<div id="board_view">
						<!-- 보안등상세내역-->
						<table summary="가로등상세" cellpadding="0" cellspacing="0">
							<colgroup>
								<col width="14%">
								<col width="36%">
								<col width="14%">
