...
<script type="text/javascript">
	...
	function saveSubmit() {
		var yn = confirm("가로등 정보를 수정하시겠습니까?");
		if(yn){
			$("#slightForm").ajaxForm({
	...
	function goToList() {
		...
		frm.action = '/equipment/streetLightList';
		frm.method ="post";
		frm.submit();
		//$("#slightForm").attr({action:'/equipment/streetLightList'}).submit();
	}
...
<div id="container">
	...
	<div id="sub">
		<div id="sub_title"><h3>가로등관리</h3></div>
		<form id="slightForm" name="slightForm">
			...
			<div id="board_view2">
				<table summary="가로등" cellpadding="0" cellspacing="0">
					<colgroup>
						<col width="20%">
						<col width="30%">
						<col width="20%">
