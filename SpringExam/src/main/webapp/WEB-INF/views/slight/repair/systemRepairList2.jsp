...
<div id="container">
	...
	<div id="local_nav_area">
		<div id="local_nav">
			<ul class="smenu">
				...
				<li><a href="#">신설현황 <img src="/resources/css/images/sub/icon_down.png" class="pdl5"/></a>
					<ul>
						<li><a href="/repair/systemRepairList">보수이력관리</a></li>
	...
	<div id="sub">
		<div id="sub_title"><h3>신설이력관리</h3></div>
		<!-- 검색박스 -->
		...
		<div id="board_list">
			<table summary="보수이력관리목록" cellpadding="0" cellspacing="0">
				<caption>접수번호,민원종류,관리번호,신고인,전화번호,접수일,지시일,보수일,처리상황,작업지시</caption>
				<colgroup>
					<col width="9%">
					<col width="12%">
					<col width="9%">
